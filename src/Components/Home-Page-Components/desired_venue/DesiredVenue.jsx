      ...
      <div className="dv-col container">
        <div className="dv-row">
          ...
          <div className="dv-li">
            <ul>
              <li>
                <Link to="jobs?title=&city=&venue=Retail&sia-licence=&salary-min=&salary-max=&lat=&lng=">
              ...
              <li>
                <Link  to="/jobs?title=&city=&venue=Coporate&sia-licence=&salary-min=&salary-max=&lat=&lng=">
              ...
              <li>
                <Link to="/jobs?title=&city=&venue=Bar/Clubs&sia-licence=&salary-min=&salary-max=&lat=&lng=">
              ...
              <li>
                <Link to="/jobs?title=&city=&venue=Event&sia-licence=&salary-min=&salary-max=&lat=&lng=">
              ...
              <li>
                <Link to="/jobs?title=&city=&venue=Mobile&sia-licence=&salary-min=&salary-max=&lat=&lng=">
